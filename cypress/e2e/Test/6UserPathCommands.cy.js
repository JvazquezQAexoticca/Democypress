...
describe('Journey of user', function () {
    ...
    it('Userpath', function () {
        ...
        cy.log('Step 4.5.HOME> PDP Go Back Home and click first cards of main offer slider')
        cy.Gohomeclickcards()
        cy.log('Step 6.PDP  try diferent departures')
        cy.Trydepartures()
        cy.log('Step 7Upgrade the accomodattion plan')
